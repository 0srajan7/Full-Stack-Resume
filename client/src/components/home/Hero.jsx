...
const Hero = () => {
    ...
    const logos = [
        { src: '/companies/instagram.svg', name: 'Instagram' },
        { src: '/companies/framer.svg', name: 'Framer' },
        { src: '/companies/microsoft.svg', name: 'Microsoft' },
        { src: '/companies/huawei.svg', name: 'Huawei' },
        { src: '/companies/walmart.svg', name: 'Walmart' },
    ]
    return (
    <>
            <div className="min-h-screen pb-20">
                ...
                <nav className="z-50 flex items-center justify-between w-full py-4 px-6 md:px-16 lg:px-24 xl:px-40 text-sm">
                    ...
                    <div className="flex gap-2">
                        ...
                        <Link to='/app' className='hidden md:block px-8 py-2 bg-green-500  hover:bg-slate-700 active:scale-95 transition-all rounded-full text-white' hidden={!user} >
                        Dashboard
                        </Link>
                    </div>
                ...
                <div className={`fixed inset-0 z-[100] bg-black/40 text-black backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-300 ${menuOpen ? "translate-x-0" : "-translate-x-full"}`} >
                    ...
                    <button onClick={() => setMenuOpen(false)} className="active:ring-3 active:ring-white aspect-square size-10 p-1 items-center justify-center bg-green-600 hover:bg-indigo-700 transition text-white rounded-md flex" >
                        X
                    </button>
                </div>
                ...
                <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-black">
                    ...
                    <h1 className="text-5xl md:text-6xl font-semibold max-w-5xl text-center mt-4 md:leading-[70px]">
                        Land Your dream  Job With <span className=" bg-gradient-to-r from-green-700 to-green-600 
                        bg-clip-text text-transparent text-nowrap">AI-powered </span> Resumes.
                    </h1>
                    ...
                    <div className="flex flex-wrap justify-between max-sm:justify-center gap-6 max-w-3xl w-full mx-auto py-4" id="logo-container">
                        {logos.map((logo, index) => (
                            <img
                                ...
                                className="h-8 object-contain grayscale opacity-70 hover:opacity-100 transition"
                            />
                        ))}
                    </div>
                </div>
