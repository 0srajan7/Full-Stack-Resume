...
const CallToAction = () => {
  return (
    <div>
            ...
            justify-between gap-8 px-3 md:px-10 border-x border-dashed border-slate-200
            py-16 sm:py-20 -mt-10 -mb-10 w-full">
                ...
                rounded py-3 px-8 bg-green-600 hover:bg-indigo-700 transition text-white">
