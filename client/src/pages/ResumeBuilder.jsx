...
const ResumeBuilder = () => {
  ...
  const setActiveSection=sections[activeSectionIndex];
  ...
  useEffect(()=>{
    console.log('ResumeBuilder useEffect, resumeId:', resumeId);
    if(resumeId){
      loadExistingResume(resumeId);
    } else {
      // For new resumes, keep the default empty state
  ...
  const renderTemplate = () => {
    ...
    return <TemplateComponent data={resumeData} accentColor={resumeData.accent_color} />;
  };
  ...
  const handleShare = () =>{
    ...
    if(navigator.share){
      ...
      alert('Share not supported in this url')
    }
  }
  ...
  const saveResume=async()=>{
    try {
      ...
      // Remove image from updated resume data if it's an object
        ...
        <div className='grid lg:grid-cols-12 gap-8'>
          ...
          <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
            <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
              {/* progress bar with active section */}
              ...
              border-gray-300 py-1'>
                ...
                <div className='flex items-center'>
                  {activeSectionIndex!==0 && (
                    ...
                    <button onClick={()=>setActiveSectionIndex((prevIndex)=>Math.max(prevIndex-1,0))} className='flex items-center gap-1 p-3 rounded-1g
              ...
              <div className='space-y-6'>
                ...
                {
                  setActiveSection.id==='experience' && (
          ...
          <div className="lg:col-span-7 max-lg:mt-6">
            <div className='relative w-full'>
              ...
              justify-end gap-2'>
                ...
                <button onClick={downloadResume} className='flex items-center p-2 px-6 gap-2 text-xs bg-gradient-to-br 
            ...
            classes="mx-auto max-w-paper-size shadow-lg"/>
